...
int main() {
    ...
    string atlasConnectionString = "mongodb+srv://swecha:amruta@cluster0.4o1cvll.mongodb.net/<dbname>?retryWrites=true&w=majority";
    Database database(atlasConnectionString);

     Car car1(1,"Hyundai", "Excellent", "Blue");
    Car car2(2,"Kia", "Fair", "Silver");
    Car car3(3,"Maruti Suzuki", "Excellent", "White");
    Car car4(4,"Mahindra", "Good", "Blue");
    Car car5(5,"Renault", "Fair", "Red");


    Customer customer1("Sahithi Reddy", 1, "pass143",1, 11, 21);
    Customer customer2("Harsha Kumar", 2, "pass739", 1, 6, 41);
    Customer customer3("Amruta", 3, "pass111", 2, 16, 30);
    Customer customer4("Mahathi Garapati", 4, "pass245", 2, 9, 75);
    Customer customer5("Krishna", 5, "pass360", 2, 8, 40);

    Employee employee1("Ravi Vardhana Reddy", 101, "empp156", 3, 21, 79);
    Employee employee2("Hema latha Reddy", 102, "empp187", 2, 19, 70);
    Employee employee3("keerthana ", 103, "empp490", 2, 40, 78);
    Employee employee4("Shiva Ganesh", 104, "pasabc", 4, 21, 33);
    Employee employee5("Kishore", 105, "empP789", 1, 2, 70);
